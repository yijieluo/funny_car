...
/* X轴数据的MSB */
#define HMC5883L_RA_DATA_OUTPUT_X_MSB    ((uint8_t)0x03)
/* X轴数据的LSB */
#define HMC5883L_RA_DATA_OUTPUT_X_LSB    ((uint8_t)0x04)
/* Z轴数据的MSB */
#define HMC5883L_RA_DATA_OUTPUT_Z_MSB    ((uint8_t)0x05)
/* Z轴数据的LSB */
#define HMC5883L_RA_DATA_OUTPUT_Z_LSB    ((uint8_t)0x06)
/* Y轴数据的MSB */
#define HMC5883L_RA_DATA_OUTPUT_Y_MSB    ((uint8_t)0x07)
...
rt_err_t mpu6050_read_byte(struct rt_i2c_bus_device *bus, rt_uint16_t reg, rt_uint8_t *buf);
...
rt_err_t mpu6050_get_gyroscope(struct imu_data*);
rt_err_t mpu6050_get_accelerometer(struct imu_data*);
...
rt_err_t hmc5883l_get_magnetic(struct imu_data*);
